...
"common.discard": "Discard",
 ...
 "logs.filter.conversation.clear": "Clear",
  ...
  "logs.metric.cacheHitTitle": "Percentage of input tokens served from cache",
...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "integrations.semantics.aside": "Manages only providers.opencodex in Aside's models.json for the signed-in account (~/.aside/u/<account>). Your other providers stay unchanged. Aside rewrites this file while running, so fully quit and reopen it after applying.",
